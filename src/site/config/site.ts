...
export const siteConfig = {
	...
	description:
		"An email provider and TypeScript SDK. Send and receive email with one token and no DNS setup, test it with throwaway Tempboi inboxes, and send SMS, WhatsApp, push and chat from the same API. You can use your own provider too, if you want to.",
